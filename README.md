...
(2015.01.27 Updated)  
```
javascript:(function(d,s){s=d.createElement('script');s.src='https://cdn.rawgit.com/Nucleareal/wlw-1/1.13/wlw-cast-custom.min.js';d.body.appendChild(s);})(document)
```  
